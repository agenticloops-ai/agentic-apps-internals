...
|---|-------|----------|-------------|--------------|-------------|--------|
| 1 | claude-haiku-4-5-20251001 **(overhead)** | 511ms | 8 | 1 | max_tokens | text: # |
| 2 | claude-opus-4-6 | 5.5s | 3 (+22,812 cached) | 224 | tool_use | think(313c), `Skill`, `Bash` |
| 3 | claude-haiku-4-5-20251001 **(overhead)** | 491ms | 343 | 32 | end_turn | text(82c) |
| 4 | claude-opus-4-6 | 6.9s | 3 (+25,552 cached) | 89 | tool_use | `Read` |
| 5 | claude-opus-4-6 | 3.4s | 1 (+91,519 cached) | 111 | tool_use | `Bash` |
| 6 | claude-haiku-4-5-20251001 **(overhead)** | 491ms | 354 | 32 | end_turn | text(82c) |
| 7 | claude-opus-4-6 | 21.3s | 1 (+91,678 cached) | 1,371 | tool_use | text(59c), `Write` |
| 8 | claude-opus-4-6 | 2.9s | 1 (+91,812 cached) | 102 | tool_use | `Bash` |
| 9 | claude-haiku-4-5-20251001 **(overhead)** | 504ms | 338 | 32 | end_turn | text(82c) |
| 10 | claude-opus-4-6 | 7.0s | 1 (+93,229 cached) | 213 | end_turn | text(762c) |
| 11 | claude-opus-4-6 | 2.8s | 71,051 (+22,812 cached) | 6 | end_turn | text: try it out |
