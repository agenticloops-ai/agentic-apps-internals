...
> This mode sent 10 requests total: 7 opus (main) + 3 haiku (overhead). The main system prompt below was identical across all 7 opus requests — only the billing header hash varied per request. The overhead prompt was identical across all 3 haiku requests.
