...
> Same user prompt structure as agent mode — 3 separate user turns with identical AGENTS.md instructions and environment context. Only the task text differs. Mode-specific behavior is controlled through tool definitions, not the user prompt.
