...
|---|-------|----------|-------------|--------------|------|-------------|--------|
| 1 | gpt-5.3-codex | 8.7s | 8,593 | 401 | $0.0255 | end_turn | think(35c), text(293c), `exec_command`, `exec_command` |
| 2 | gpt-5.3-codex | 3.7s | 9,103 | 177 | $0.0245 | end_turn | think(32c), text(158c), `exec_command`, `exec_command` |
| 3 | gpt-5.3-codex | 55.8s | 9,489 | 3,886 | $0.0626 | end_turn | think(43c), text(290c) |
| 4 | gpt-5.3-codex | 6.0s | 13,433 | 209 | $0.0357 | end_turn | think(45c), text(150c), `exec_command`, `exec_command` |
| 5 | gpt-5.3-codex | 15.4s | 13,954 | 236 | $0.0372 | end_turn | think(45c), text(176c), `exec_command`, `exec_command` |
